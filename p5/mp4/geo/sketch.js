...
function preload() {
  ...
  reggieImg = loadImage('assets/beau.jpg');
...
function setup() {
  ...
  places.push(new Place(34.073952519267564, -118.1156540522421, "Henry's Room", .02, reggieImg)); // new Place object, for CVA room 17
